...
- **Frameworks & Libraries:** LangChain, LangGraph, Scikit-learn, PyTorch, TensorFlow, OpenCV, YOLO, Ultralytics
- **Web & Automation:** FastAPI, Flask, Streamlit, Playwright
- **Databases:** Neo4j, FAISS, Chroma, PostgreSQL, Redis, SQLite
...
- Trained an object detection model on annotated logistics datasets to segment container yard objects, extract key information via OCR, and save live stream data into database with 75% accuracy.
- Architected end-to-end ML pipelines for real estate price forecasting using hyperparameter optimization and cross-validation.
- Built a property recommendation system using cosine similarity, DBSCAN, and K-Nearest Neighbors to map user preferences to property features.
